# WebSCADA Kubernetes Deployment Guide

This directory contains Kubernetes manifests and deployment configurations for the WebSCADA MVP system.
...
**Development:** Plain Kubernetes Secrets in `base/backend-secrets.yaml`
